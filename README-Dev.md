...
| `i24` (Jul 30)| YOLO11N-P2 | 260 / 16 | 512 / 16 / 99 | 94.8% | 95.1% | 98.4% | 53.6% | *`i24` Model (SGD Optimized). Switched back to SGD (`lr0=0.01`). Slower convergence but found an even deeper global minimum at Epoch 49. Achieved all-time high records across every single metric, including 53.6% mAP50-95! SGD is definitively the superior optimizer for this dataset.* |
| `frcnn` (Jul 31)| Faster R-CNN | 260 / 16 | 512 / 16 / 50 | - | - | 92.3% | 47.4% | *Faster R-CNN ResNet50-FPN V2 experiment. Trained for 50 epochs using SGD. Achieved incredible convergence (0.12 loss), but YOLO11n-P2 heavily outperformed it in both mAP50 and mAP50-95 while training 6x faster. YOLO11n-P2 definitively remains the superior architecture for this project.* |
